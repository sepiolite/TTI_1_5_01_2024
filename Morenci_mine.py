...
#Other 
d_y = 1300 #depth of the path (m)
road_gradient = 0.1 #angle of the road, 10 % is the maximum 
C_y = 0.0023 #The ore grade
R_y_P = 0.63 #recovery rate of processing 
R_y_Me = 0.63 #recovery rate of metallurgy
...
##1. hydro
print("Etotale")
print("E_elec = " + str(E_elec_total("OP",SR_y_OP_result=0.46,procss="leaching",mtallurgy="hydrometallurgy")) + " MJ/t Cu")
print("E_fuel = " + str(E_fuel_total("OP",SR_y_OP_result=0.46,mtallurgy="hydrometallurgy"))+ " MJ/t Cu")

##2. Extraction
print("Eextraction")
print("E_elec = " + str(E_y_mine_elec_calcul (type_of_mine="OP",SR_y_OP=0.46)) + " MJ/t ore")
print("E_fuel = " + str(E_y_mine_fuel_calcul (type_of_mine="OP",SR_y_OP=0.46)) + " MJ/t ore")
...
##1. hydro
print("gtotale")
print("g_elec = " + str(g_CO2_elec_total("OP",SR_y_OP_result=0.46,procss="leaching",mtallurgy="hydrometallurgy",e_case_scenario=best_case_scenario)) + " g CO2 / t Cu")
print("g_fuel = " + str(g_CO2_carbonated_total("OP",SR_y_OP_result=0.46,mtallurgy="hydrometallurgy"))+ " g CO2 / t Cu")

##2. Extraction
print("gextraction")
print("g_elec = " + str(g_CO2_mine_elec_calcul(type_of_mine="OP",SR_y_OP=0.46,energy_case_scenario=best_case_scenario)) + " g CO2/t ore")
print("g_fuel = " + str(g_CO2_mine_fuel_calcul(type_of_mine="OP",SR_y_OP=0.46)) + " g CO2/t ore")
...
##1. hydro
print("gtotale")
print("g_elec = " + str(g_CO2_elec_total("OP",SR_y_OP_result=0.46,procss="leaching",mtallurgy="hydrometallurgy",e_case_scenario=worst_case_scenario)) + " g CO2 / t Cu")
print("g_fuel = " + str(g_CO2_carbonated_total("OP",SR_y_OP_result=0.46,mtallurgy="hydrometallurgy"))+ " g CO2 / t Cu")

##2. Extraction
print("gextraction")
print("g_elec = " + str(g_CO2_mine_elec_calcul(type_of_mine="OP",SR_y_OP=0.46,energy_case_scenario=worst_case_scenario)) + " g CO2/t ore")
print("g_fuel = " + str(g_CO2_mine_fuel_calcul(type_of_mine="OP",SR_y_OP=0.46)) + " g CO2/t ore")
...
##1. hydro
print("gtotale")
print("g_elec = " + str(g_CO2_elec_total("OP",SR_y_OP_result=0.46,procss="leaching",mtallurgy="hydrometallurgy",e_case_scenario=country_case_scenario)) + " g CO2 / t Cu")
print("g_fuel = " + str(g_CO2_carbonated_total("OP",SR_y_OP_result=0.46,mtallurgy="hydrometallurgy"))+ " g CO2 / t Cu")

##2. Extraction
print("gextraction")
print("g_elec = " + str(g_CO2_mine_elec_calcul(type_of_mine="OP",SR_y_OP=0.46,energy_case_scenario=country_case_scenario)) + " g CO2/t ore")
print("g_fuel = " + str(g_CO2_mine_fuel_calcul(type_of_mine="OP",SR_y_OP=0.46)) + " g CO2/t ore")
